...
const AboutSection: React.FC<AboutSectionProps> = ({ visible, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md p-6 rounded-xl shadow-xl max-w-2xl w-full mx-4 relative">
                <button 
                    onClick={onClose}
                ...
                <div className="space-y-8 overflow-y-auto max-h-[80vh] pr-2">
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white/50 dark:bg-gray-900/50 p-4 rounded-lg">
                                <h4 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2 flex items-center gap-2">
                                    See it in a Pie
                                </h4>
                                ...
                                <p className="pt-4 text-m text-teal-700 dark:text-teal-300 shadow-sm">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <div className="bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg text-center">React</div>
                            <div className="bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg text-center">Tailwind CSS</div>
                            <div className="bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg text-center">TypeScript</div>
                            <div className="bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg text-center">VS Code</div>
                            <div className="bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg text-center">
                                <span>Anime.js</span>
                                <span className="ml-1">🎬</span>
                            </div>
                            <div className="bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg text-center">Vite</div>
                        </div>
                    </div>
                    ...
                    <div className="text-center pt-4">
                        <a 
                            ...
                            className="inline-flex items-center gap-2 text-teal-600 dark:text-teal-400 hover:text-teal-500 dark:hover:text-teal-300 transition-colors"
                        >
